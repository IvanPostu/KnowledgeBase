...
public final class WebResourceFactory implements InvocationHandler {
     ...
     * @param target            WebTarget pointing to the resource or the parent of
     *                          the resource.
     * @return Instance of a class implementing the resource interface that can be
     *         used for making requests to the server.
     */
     ...
     * @param target             WebTarget pointing to the resource or the parent of
     *                           the resource.
     * @param ignoreResourcePath If set to true, ignores path annotation on the
     *                           resource interface (this is used when creating
     *                           sub-resources)
     * @param headers            Header params collected from parent resources (used
     *                           when creating a sub-resource)
     * @param cookies            Cookie params collected from parent resources (used
     *                           when creating a sub-resource)
     * @param form               Form params collected from parent resources (used
     *                           when creating a sub-resource)
     * @return Instance of a class implementing the resource interface that can be
     *         used for making requests to the server.
     */
